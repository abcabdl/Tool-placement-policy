...
- High parameter/adapter signal among observed tools: 50
...
| Tool | Server | Calls | Score | Compact R@10 | Template Share | Full Chars | Recommendation |
|---|---|---:|---:|---:|---:|---:|---|
| brightdata-mcp_extract | Bright Data | 30 | 1.000 | 0.433 | 1.000 | 765 | vocab/template;parameter/adapter |
| brightdata-mcp_web_data_linkedin_people_search | Bright Data | 30 | 0.982 | 0.633 | 1.000 | 628 | vocab/template;parameter/adapter |
| brightdata-mcp_web_data_google_maps_reviews | Bright Data | 30 | 0.976 | 0.800 | 1.000 | 588 | vocab/template;parameter/adapter |
| brightdata-mcp_search_engine | Bright Data | 30 | 0.968 | 0.200 | 1.000 | 704 | vocab/template;parameter/adapter |
| brightdata-mcp_web_data_amazon_product_search | Bright Data | 28 | 0.967 | 0.786 | 1.000 | 688 | vocab/template;parameter/adapter |
| brightdata-mcp_web_data_reuter_news | Bright Data | 30 | 0.960 | 0.700 | 1.000 | 499 | vocab/template;parameter/adapter |
| brightdata-mcp_web_data_youtube_comments | Bright Data | 29 | 0.960 | 0.655 | 1.000 | 590 | vocab/template;parameter/adapter |
| brightdata-mcp_scraping_browser_type | Bright Data | 30 | 0.945 | 0.800 | 1.000 | 661 | vocab/template;parameter/adapter |
| brightdata-mcp_web_data_linkedin_company_profile | Bright Data | 28 | 0.944 | 0.893 | 1.000 | 482 | vocab/template;parameter/adapter |
| brightdata-mcp_scraping_browser_navigate | Bright Data | 30 | 0.943 | 0.267 | 1.000 | 423 | vocab/template;parameter/adapter |
| brightdata-mcp_scraping_browser_click | Bright Data | 30 | 0.941 | 0.533 | 1.000 | 514 | vocab/template;parameter/adapter |
...
| Tool | Server | Calls | Score | Compact R@10 | Template Share | Full Chars | Recommendation |
|---|---|---:|---:|---:|---:|---:|---|
| brightdata-mcp_search_engine | Bright Data | 30 | 0.766 | 0.200 | 1.000 | 704 | vocab/template;parameter/adapter |
...
| brightdata-mcp_scraping_browser_navigate | Bright Data | 30 | 0.732 | 0.267 | 1.000 | 423 | vocab/template;parameter/adapter |
| brightdata-mcp_extract | Bright Data | 30 | 0.724 | 0.433 | 1.000 | 765 | vocab/template;parameter/adapter |
...
| brightdata-mcp_web_data_linkedin_people_search | Bright Data | 30 | 0.709 | 0.633 | 1.000 | 628 | vocab/template;parameter/adapter |
| brightdata-mcp_scraping_browser_links | Bright Data | 30 | 0.705 | 0.333 | 1.000 | 383 | vocab/template;parameter/adapter |
| brightdata-mcp_scraping_browser_click | Bright Data | 30 | 0.703 | 0.533 | 1.000 | 514 | vocab/template;parameter/adapter |
| brightdata-mcp_scraping_browser_type | Bright Data | 30 | 0.691 | 0.800 | 1.000 | 661 | vocab/template;parameter/adapter |
| brightdata-mcp_scraping_browser_go_back | Bright Data | 26 | 0.690 | 0.000 | 1.000 | 263 | vocab/template;parameter/adapter |
